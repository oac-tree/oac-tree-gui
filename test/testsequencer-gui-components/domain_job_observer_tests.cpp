...
{
public:
  mvvm::test::MockCallbackListener<experimental::domain_event_t> m_job_status_listener;
};
...
{
  experimental::DomainJobObserver observer(m_job_status_listener.CreateCallback());

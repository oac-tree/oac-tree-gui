...
TEST_F(DragAndDropHelperTest, GetListInternalMoveRowForFirstItem)
{
  ...
  {  // hovering case [5]
    ...
    EXPECT_EQ(GetListInternalMoveRow(drop_indicator, source_row, parent_index), 3);
  }

...
void InstructionEditorActions::SetupInsertRemoveActions()
{
  ...
  m_action_map[ActionKey::kInsertAfter] = m_insert_after_action;
  ...
  m_action_map[ActionKey::kInsertInto] = m_insert_into_action;
  ...
  m_action_map[ActionKey::kRemoveSelected] = m_remove_toolbar_action;
  ...
  m_action_map[ActionKey::kMoveUp] = m_move_up_action;
  ...
  m_action_map[ActionKey::kMoveDown] = m_move_down_action;
}
...
void InstructionEditorActions::SetupCutCopyPasteActions()
{
  ...
  m_action_map[ActionKey::kPasteAfter] = m_paste_after_action;
  ...
  m_action_map[ActionKey::kPasteInto] = m_paste_into_action;
}

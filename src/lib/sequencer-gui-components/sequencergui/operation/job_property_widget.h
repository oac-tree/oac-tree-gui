...
#ifndef SEQUENCERGUI_OPERATION_JOB_PROPERTY_WIDGET_H_
#define SEQUENCERGUI_OPERATION_JOB_PROPERTY_WIDGET_H_
...
#endif  // SEQUENCERGUI_OPERATION_JOB_PROPERTY_WIDGET_H_

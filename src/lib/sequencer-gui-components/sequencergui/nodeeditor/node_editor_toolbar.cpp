    ...
    , m_align_button(new QToolButton)
{
  ...
  m_pointer_button->setIcon(styleutils::GetIcon("arrow-top-left"));
  ...
  m_pan_button->setIcon(styleutils::GetIcon("hand-back-right-outline"));
  ...
  m_zoom_button->setIcon(styleutils::GetIcon("magnify-plus-outline"));
  ...
  m_center_button->setIcon(styleutils::GetIcon("camera-metering-center"));
  ...
  m_align_button->setIcon(styleutils::GetIcon("dots-triangle"));

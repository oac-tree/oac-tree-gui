...
#ifndef OAC_TREE_GUI_OPERATION_OBJECTS_WORKSPACE_VIEW_COMPONENT_PROVIDER_H_
#define OAC_TREE_GUI_OPERATION_OBJECTS_WORKSPACE_VIEW_COMPONENT_PROVIDER_H_
...
#endif  // OAC_TREE_GUI_OPERATION_OBJECTS_WORKSPACE_VIEW_COMPONENT_PROVIDER_H_

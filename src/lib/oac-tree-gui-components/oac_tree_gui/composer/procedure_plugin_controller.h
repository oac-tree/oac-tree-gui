...
#ifndef OAC_TREE_GUI_COMPOSER_PROCEDURE_PLUGIN_CONTROLLER_H_
#define OAC_TREE_GUI_COMPOSER_PROCEDURE_PLUGIN_CONTROLLER_H_
...
#endif  // OAC_TREE_GUI_COMPOSER_PROCEDURE_PLUGIN_CONTROLLER_H_

...
constexpr auto kSupConfigPluginName = "oac-tree-sup-config";
constexpr auto kSupTimingPluginName = "oac-tree-sup-timing";
constexpr auto kSupPulseCounterPluginName = "oac-tree-sup-pulse-counter";

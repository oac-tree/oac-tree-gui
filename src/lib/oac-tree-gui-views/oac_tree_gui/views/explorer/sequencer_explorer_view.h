 ...
 *
 * It is a first main view of sequencer main window. Contains 2 vertical panels:
 * - file browser and list of opened procedures on the left panel
 * - XML viewer on the right panel
 */
